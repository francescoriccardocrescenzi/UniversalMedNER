...
import sft_code as trc
import eval_code as tsc
...
def parse_args():
    ...
    parser.add_argument("--hf_config", type=str, default='hf_config.yaml')
...
if __name__ == "__main__":
    ...
    # --- LOAD MODEL ---
    print(' **** Loading model ****')
    gemma_id = hf_config['source_repo']
    sft_gemma_id = hf_config['checkpoint_repo']
